---
title: Dark mode in React and Tailwind in 3 simple steps
date: 2022-03-25
published: true
---
...
(hint: if you are using next.js, put this in the file being import in app.tsx and index.js for CRA)
...
Add an onClick handler to toggle between the modes, also we store it in localStorage for later.
...
Let's add some cool icons and styling, I'll just show the finished code:
...
Thats it! We could improve this more by on default use the preferred browser theme, and also avoiding a flash of light,
but this should get you pretty far.
I recommend this brilliant post by joshwcomeu: https://www.joshwcomeau.com/react/dark-mode/
